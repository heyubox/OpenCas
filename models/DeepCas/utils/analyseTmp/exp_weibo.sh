...
python -u gen_walks.py --rawdataset=dataset_weibo.txt --dataset=weibo1/ --observation_time=3600 --up_num=100
...
python -u gen_walks.py --rawdataset=dataset_weibo.txt --dataset=weibo2/ --observation_time=7200 --up_num=100
...
python -u gen_walks.py --rawdataset=dataset_weibo.txt --dataset=weibo3/ --observation_time=10800 --up_num=100
