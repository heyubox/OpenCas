...
# python -u gen_cas.py --rawdataset=dataset_dblp.txt --dataset=dblp0/ --observation_time=3 --least_num=10 --up_num=100
# python -u gen_run.py --rawdataset=dataset_dblp.txt --dataset=dblp0/ --observation_time=3 --least_num=10 --up_num=100
# python -u run.py --rawdataset=dataset_dblp.txt --dataset=dblp0/ --observation_time=3 --least_num=10 --up_num=100 > 3.log