...
# python -u  gen_cas.py --rawdataset=dataset_citation.txt --dataset=citation4/ --observation_time=3960  --up_num=100 --least_num=10
# python -u gen_run.py --rawdataset=dataset_citation.txt --dataset=citation4/ --observation_time=3960  --up_num=100 --least_num=10
# python -u run.py --rawdataset=dataset_citation.txt --dataset=citation4/ --observation_time=3960  --up_num=100  --least_num=10 > 3960.log 